...
-- Recovery tracking for identity KEL
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_identity_recovery_prefix_version ON identity_recovery(prefix, version);
CREATE UNIQUE INDEX IF NOT EXISTS idx_identity_recovery_kel_prefix_version ON identity_recovery(kel_prefix, version);
