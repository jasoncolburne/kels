...
data:
  redis.conf: |
    ...
    # ACL: Gossip service
    user gossip on #${var.redis.gossipPasswordHash} ~kels:gossip:* ~kels:anti_entropy:* &kel_updates &sad_updates &sel_updates &iel_updates &mail_updates +get +set +del +subscribe +hset +hgetall +ping
