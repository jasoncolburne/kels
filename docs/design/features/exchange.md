...
**Discovery:** Anyone computes the SEL prefix offline: take the publisher's IEL identity prefix and call `compute_sad_event_prefix(identity, "kels/sad/v1/keys/mlkem")`. Query any SADStore node for the latest event.
