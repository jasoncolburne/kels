...
SelVerification:
    prefix: Digest256
    branches: Vec<BranchTip>                  // 1 = linear, 2 = divergent (or 3 with privileged-event upgrade)
