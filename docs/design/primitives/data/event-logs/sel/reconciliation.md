...
| **Divergent (sealed)** | `ContestRequired` | `ContestRequired` | `ContestRequired` | `ContestRequired` (linear); extending `v_{d-1}` → Contested via upgrade rule |
