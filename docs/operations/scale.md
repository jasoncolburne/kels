...
- Fork-of-authority is first-class — two admin factions disagreeing on a peer manifest as divergence; cross-node priv-vs-priv races between factions surface as federation-level dispute via the contested-prefix table.
