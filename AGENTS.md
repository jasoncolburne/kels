...
**SAD Event Log** — append-only, versioned, policy-governed data chain in SADStore. Each record links to previous via SAID and is authorized by `write_policy`. Checkpoint policy bounds divergence. See `docs/design/sad-events.md`.
